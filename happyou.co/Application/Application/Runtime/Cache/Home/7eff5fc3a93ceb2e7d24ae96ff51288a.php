...
<div class="container">
    <div class="margin text-center text-blue">
        <div class="margin">用户名：<?php echo ($_SESSION['user']['username']); ?></div>
        <div class="margin">邮箱：<?php echo ($_SESSION['user']['email']); ?></div>
        <div class="margin">账户状态：正常</div>
    </div>
</div>

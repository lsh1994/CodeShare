...
<div class="container">
    <div class="border border-blue padding">
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="panel margin-large">
                <div class="panel-body">
                    <a href="<?php echo ($vo["article_url"]); ?>"><h2 class="margin text-green"><?php echo ($vo["title"]); ?></h2></a>
                    <div class="padding"><?php echo ($vo["content"]); ?>...</div>
                    <div class="text-small text-right">
                        <span class="margin-right">发布时间：<?php echo ($vo["date"]); ?></span>
                        <span class="margin-right">作者：<?php echo ($vo["nickname"]); ?></span>
                    </div>
                    <div class="text-small text-right">
                        <span class="margin-right margin">公众号：<?php echo ($vo["media_value"]); ?></span>
                    </div>
                </div>
